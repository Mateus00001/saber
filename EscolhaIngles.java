...
import com.mycompany.projetoquiz.PerguntaIngles;
 ...
 * @author User
 */
public class EscolhaIngles extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public EscolhaIngles() {
        initComponents();
    }
    ...
    private void btnMemorizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMemorizarActionPerformed
       PerguntaIngles t11=new PerguntaIngles();
        t11.setVisible(true);
        this.dispose(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscolhaIngles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EscolhaIngles().setVisible(true);
            }
        });
    }
