 ...
 */
package trabalho;
import com.mycompany.projetoquiz.PerguntaJava;
import com.mycompany.projetoquiz.Quiz;
/**
 *
 * @author User
 */
public class EscolhaJava extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEstudarJava = new javax.swing.JButton();
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 210, 200, 40));
        ...
        btnEstudarJava.setFont(new java.awt.Font("Lucida Handwriting", 1, 14)); // NOI18N
        btnEstudarJava.setText("ESTUDAR");
        btnEstudarJava.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnEstudarJava.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEstudarJavaActionPerformed(evt);
            }
        });
        jPanel1.add(btnEstudarJava, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 100, 30));
    ...
    private void btnEstudarJavaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEstudarJavaActionPerformed
         menuJava t9=new menuJava();
        t9.setVisible(true);
        this.dispose();   
    }//GEN-LAST:event_btnEstudarJavaActionPerformed

    private void btnMemorizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMemorizarActionPerformed
        PerguntaJava t10=new PerguntaJava();
        t10.setVisible(true);
        this.dispose(); 
    }//GEN-LAST:event_btnMemorizarActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscolhaJava.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EscolhaJava().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnEstudarJava;
